...
function M.default_colorsheme()
    require('kanagawa').setup {
        ...
        overrides = function(colors)
            ...
            return {
                MiniStarterHeader = { fg = palette_colors.peachRed, bold = true },
                MiniStarterFooter = { fg = palette_colors.sumiInk6, italic = true },
                MiniStarterItemBullet = { fg = palette_colors.winterYellow },
                MiniStarterSection = { fg = palette_colors.carpYellow, bg = palette_colors.sumiInk2, italic = true },
                MiniStarterItemPrefix = { fg = palette_colors.oldWhite },
                MiniStarterItem = { fg = palette_colors.fujiGray },
                MiniStarterInactive = { fg = palette_colors.fujiGray },
                MiniStarterCurrent = { fg = palette_colors.fujiWhite, bg = palette_colors.waveBlue1 },
                MiniStarterQuery = { fg = palette_colors.crystalBlue },
